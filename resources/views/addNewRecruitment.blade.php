<x-app-layout>
    <div class="mx-auto mt-20 max-w-3xl p-6 bg-white shadow-md rounded">
        ...
        <form action="{{ route('addRecruitment.store') }}" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input id="name" type="text" name="name" class="form-control mt-1 block w-full" required>
                @error('jobDetail.name')
